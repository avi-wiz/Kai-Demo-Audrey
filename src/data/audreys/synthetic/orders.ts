...
export const ORDERS: AudreyOrder[] = [
  ...
  mk('O-50001', 'C-8001', 'Magnolia Home & Garden', BETH.id, BETH.name, '2026-05-04', 'Shipped', 'featured_collections', [ln('51GR1779-U', 12), ln('51GR1780', 24), ln('51GR1871', 4)], undefined, '2026-05-07'),
  mk('O-50002', 'C-8001', 'Magnolia Home & Garden', BETH.id, BETH.name, '2026-04-12', 'Delivered', 'featured_collections', [ln('51GR1888', 12), ln('51GR1844', 4)], undefined, '2026-04-16'),
  ...
  mk('O-50004', 'C-8002', 'The Potting Shed', BETH.id, BETH.name, '2026-04-08', 'Delivered', 'featured_collections', [ln('51GR1864', 24), ln('51GR1676', 3)], undefined, '2026-04-12'),
  ...
  mk('O-50006', 'C-8003', 'Bloom & Basket', MARCUS.id, MARCUS.name, '2026-04-02', 'Shipped', 'featured_collections', [ln('51GR1905', 8), ln('51GR1844', 4)], undefined, '2026-04-05'),
  ...
  mk('O-50008', 'C-8005', 'Copper Creek Trading', HANNAH.id, HANNAH.name, '2026-04-18', 'Delivered', 'featured_collections', [ln('51GR1871', 2), ln('51GR1844', 4)], undefined, '2026-04-22'),
  ...
  mk('O-50010', 'C-8007', 'Sunflower & Sage', BETH.id, BETH.name, '2026-04-05', 'Shipped', 'featured_collections', [ln('51GR1880', 16), ln('51GR1905', 6)], undefined, '2026-04-08'),
  mk('O-50011', 'C-8001', 'Magnolia Home & Garden', BETH.id, BETH.name, '2026-02-22', 'Delivered', 'featured_collections', [ln('51GR1779-U', 8), ln('51GR1929', 24)], undefined, '2026-02-26'),
  mk('O-50012', 'C-8003', 'Bloom & Basket', MARCUS.id, MARCUS.name, '2026-02-19', 'Delivered', 'featured_collections', [ln('51GR1522-U', 4), ln('51GR1888', 8)], undefined, '2026-02-23'),
  ...
  mk('O-50021', 'C-8001', 'Magnolia Home & Garden', BETH.id, BETH.name, '2026-04-12', 'Delivered', 'garden_outdoor', [ln('51GR1928', 8), ln('51GR1900', 12)], undefined, '2026-04-16'),
  mk('O-50022', 'C-8004', 'Seaside Gifts', MARCUS.id, MARCUS.name, '2026-04-30', 'Shipped', 'garden_outdoor', [ln('51GR1943', 6), ln('51GR1898', 12)], undefined, '2026-05-03'),
  mk('O-50023', 'C-8004', 'Seaside Gifts', MARCUS.id, MARCUS.name, '2026-03-25', 'Delivered', 'garden_outdoor', [ln('51GR1900', 8), ln('51GR1928', 4)], undefined, '2026-03-29'),
  mk('O-50024', 'C-8004', 'Seaside Gifts', MARCUS.id, MARCUS.name, '2026-02-14', 'Delivered', 'garden_outdoor', [ln('51GR1916', 16), ln('51GR1898', 6)], undefined, '2026-02-18'),
  mk('O-50025', 'C-8005', 'Copper Creek Trading', HANNAH.id, HANNAH.name, '2026-03-30', 'Delivered', 'garden_outdoor', [ln('51GR1904', 4), ln('51GR1944', 8)], undefined, '2026-04-03'),
  mk('O-50026', 'C-8007', 'Sunflower & Sage', BETH.id, BETH.name, '2026-03-15', 'Shipped', 'garden_outdoor', [ln('51GR1898', 6), ln('51GR1916', 16)], undefined, '2026-03-18'),
